...
export const articles: Article[] = [
  {
    ...
    description:
      "A realistic way to create a morning that steadies you\u2014without a 5 a.m. alarm or an impossible checklist.",
    ...
    imageAlt:
      "Morning sunlight falling across sage and cream linen bedding beside a cup of tea",
    html: morningRhythm,
  },
  {
    ...
    description:
      "A realistic evening rhythm built around consistent cues, an earlier caffeine cutoff, and a calmer relationship with technology.",
    category: "Rest",
    date: "July 17, 2026",
    readTime: "8 min read",
    author: "The Wellbeing Edit",
    ...
    imageAlt:
      "A warmly lit bedroom at dusk with a book, tea, and a phone placed face-down",
    html: bedtimeRoutine,
  },
];
